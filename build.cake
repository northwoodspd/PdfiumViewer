...
var nugetRoot = "https://northwoodspd.jfrog.io/northwoodspd/api/nuget/nuget";
var testAssemblyPattern = "*.Test";
...
Action nugetPack = () =>
{
    ...
    var slnProjects = sln.Projects.Where(pro => !pro.Name.Contains(".Test") && pro.Path.FullPath.EndsWith("proj"));
...
Action nugetPush = () =>
{
    ...
    NuGetPush(packages, new NuGetPushSettings {
        Source = $"{nugetRoot}/Northwoods/{solutionName()}"
    });
};
